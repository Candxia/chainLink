...
func Router(group *ghttp.RouterGroup) {
	...
	// ==================== 账号管理 ====================
	sysGroup.GET("/admin", system.Ctl.AdminList)
	sysGroup.GET("/admin/:id", system.Ctl.AdminInfo)
	sysGroup.POST("/admin", system.Ctl.AdminAdd)
	sysGroup.PUT("/admin/:id", system.Ctl.AdminEdit)
	sysGroup.DELETE("/admin/:id", system.Ctl.AdminDel)
	sysGroup.PUT("/admin/:id/password", system.Ctl.AdminPassword)
	sysGroup.PUT("/admin/:id/status", system.Ctl.AdminStatus)
	sysGroup.PUT("/admin/:id/clickout", system.Ctl.AdminClickOut)

	// ==================== API管理 ====================
	sysGroup.GET("/api", system.Ctl.ApiList)
	sysGroup.POST("/api", system.Ctl.ApiAdd)
	sysGroup.PUT("/api/:id", system.Ctl.ApiEdit)
	sysGroup.DELETE("/api/:id", system.Ctl.ApiDel)
	sysGroup.GET("/api/dropdown", system.Ctl.ApiDrop)
	sysGroup.GET("/api/path", system.Ctl.ApiPath)

	// ==================== 角色管理 ====================
	sysGroup.GET("/role", system.Ctl.RoleList)
	sysGroup.GET("/role/:id", system.Ctl.RoleInfo)
	sysGroup.POST("/role", system.Ctl.RoleAdd)
	sysGroup.PUT("/role/:id", system.Ctl.RoleEdit)
	sysGroup.DELETE("/role/:id", system.Ctl.RoleDel)
	sysGroup.PUT("/role/:id/status", system.Ctl.RoleStatus)
	sysGroup.GET("/role/dropdown", system.Ctl.RoleDrop)
	sysGroup.PUT("/role/:id/is_mobile", system.Ctl.RoleIsMobile)

	// ==================== 菜单管理 ====================
	sysGroup.GET("/menu", system.Ctl.MenuList)
	sysGroup.GET("/menu/:id", system.Ctl.MenuInfo)
	sysGroup.POST("/menu", system.Ctl.MenuAdd)
	sysGroup.PUT("/menu/:id", system.Ctl.MenuEdit)
	sysGroup.DELETE("/menu/:id", system.Ctl.MenuDel)
	sysGroup.GET("/menu/role", system.Ctl.MenuRole)
	sysGroup.GET("/menu/dropdown", system.Ctl.MenuDrop)

	// ==================== 部门管理 ====================
	sysGroup.GET("/dept", system.Ctl.DeptList)
	sysGroup.GET("/dept/:id", system.Ctl.DeptInfo)
	sysGroup.POST("/dept", system.Ctl.DeptAdd)
	sysGroup.PUT("/dept/:id", system.Ctl.DeptEdit)
	sysGroup.DELETE("/dept/:id", system.Ctl.DeptDel)
