...
VALUES
(1,'管理员列表','/system/admin','BUS','GET',1,UNIX_TIMESTAMP()),
(2,'管理员详情','/system/admin/:id','BUS','GET',2,UNIX_TIMESTAMP()),
(3,'添加管理员','/system/admin','BUS','POST',1,UNIX_TIMESTAMP()),
(4,'编辑管理员','/system/admin/:id','BUS','PUT',1,UNIX_TIMESTAMP()),
(5,'删除管理员','/system/admin/:id','BUS','DELETE',1,UNIX_TIMESTAMP()),
(6,'修改密码','/system/admin/:id/password','BUS','PUT',1,UNIX_TIMESTAMP()),
(7,'修改状态','/system/admin/:id/status','BUS','PUT',1,UNIX_TIMESTAMP()),
(8,'踢下线','/system/admin/:id/clickout','BUS','PUT',1,UNIX_TIMESTAMP()),
(9,'接口列表','/system/api','SYS','GET',2,UNIX_TIMESTAMP()),
(10,'添加接口','/system/api','SYS','POST',1,UNIX_TIMESTAMP()),
(11,'编辑接口','/system/api/:id','SYS','PUT',1,UNIX_TIMESTAMP()),
(12,'删除接口','/system/api/:id','SYS','DELETE',1,UNIX_TIMESTAMP()),
(13,'接口下拉','/system/api/dropdown','DEF','GET',2,UNIX_TIMESTAMP()),
(14,'接口路径下拉','/system/api/path','DEF','GET',2,UNIX_TIMESTAMP()),
(15,'角色列表','/system/role','BUS','GET',2,UNIX_TIMESTAMP()),
(16,'角色详情','/system/role/:id','BUS','GET',2,UNIX_TIMESTAMP()),
(17,'添加角色','/system/role','BUS','POST',1,UNIX_TIMESTAMP()),
(18,'编辑角色','/system/role/:id','BUS','PUT',1,UNIX_TIMESTAMP()),
(19,'删除角色','/system/role/:id','BUS','DELETE',1,UNIX_TIMESTAMP()),
(20,'修改角色状态','/system/role/:id/status','BUS','PUT',1,UNIX_TIMESTAMP()),
(21,'角色下拉','/system/role/dropdown','DEF','GET',2,UNIX_TIMESTAMP()),
(22,'角色手机号','/system/role/:id/is_mobile','BUS','PUT',1,UNIX_TIMESTAMP()),
(23,'菜单列表','/system/menu','SYS','GET',2,UNIX_TIMESTAMP()),
(24,'菜单详情','/system/menu/:id','SYS','GET',2,UNIX_TIMESTAMP()),
(25,'添加菜单','/system/menu','SYS','POST',1,UNIX_TIMESTAMP()),
(26,'编辑菜单','/system/menu/:id','SYS','PUT',1,UNIX_TIMESTAMP()),
(27,'删除菜单','/system/menu/:id','SYS','DELETE',1,UNIX_TIMESTAMP()),
(28,'角色菜单(权限)','/system/menu/role','DEF','GET',2,UNIX_TIMESTAMP()),
(29,'菜单下拉','/system/menu/dropdown','DEF','GET',2,UNIX_TIMESTAMP());
